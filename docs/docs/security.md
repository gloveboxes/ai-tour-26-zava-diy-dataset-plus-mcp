...
This app uses a PostgresSQL database, the agent app has been assigned limited privileges in the database to mitigate potential issues. Running the app in a secure environment further enhances protection.
